...
juno_screen = UIScreen(offset_y=100)
...
juno_screen.add([arp, lfo, dco, hpf, vcf, vca, env, ch])
juno_screen.add(patch_selector, relative=vcf, direction=lv.ALIGN.OUT_TOP_MID)
juno_screen.add(midi_selector) # the second add after relative will be relative to the last obj added
